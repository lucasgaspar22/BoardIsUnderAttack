...
public class LevelThreeBehaviour : LevelBehaviour
{
    ...
    void Update()
    {
        indicator.transform.position = new Vector3(Objective.transform.position.x, 38.2909f, Objective.transform.position.z);
    }
